...
public class AXmlResourceParser implements XmlResourceParser {
	 ...
	 * Data=DepthFrame*; DepthFrame=Count+[Prefix+Uri]*+Count; Count='count of Prefix+Uri
	 * pairs'; Yes, count is stored twice, to enable bottom-up traversal. increaseDepth
	 * adds depth frame, decreaseDepth removes it. push/pop operations operate only in
	 * current depth frame. decreaseDepth removes any remaining (not pop'ed) namespace
	 * pairs. findXXX methods search all depth frames starting from the last namespace
	 * pair of current depth frame. All functions that operate with int, use -1 as
	 * 'invalid value'.
	 *
	...
	private static final int CHUNK_AXML_FILE = 0x00080003, CHUNK_RESOURCEIDS = 0x00080180, CHUNK_XML_FIRST = 0x00100100,
			CHUNK_XML_START_NAMESPACE = 0x00100100, CHUNK_XML_END_NAMESPACE = 0x00100101,
