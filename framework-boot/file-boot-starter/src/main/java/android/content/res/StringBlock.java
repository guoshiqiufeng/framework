...
public class StringBlock {
	...
	/**
	 * Reads whole (including chunk type) string block from stream. Stream must be at the
	 * chunk type.
	 */
	...
	/**
	 * Returns style information - array of int triplets, where in each triplet: * first
	 * int is index of tag name ('b','i', etc.) * second int is tag start index in string
